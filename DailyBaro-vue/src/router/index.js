...
import Recommendations from '@/components/user/Recommendations.vue'
...
const routes = [
  ...
  // 用户页面
  {
    ...
    children: [
      ...
      { path: 'knowledge', component: () => import('@/components/user/Knowledge.vue'), meta: { title: '心理健康知识库' } },
      { path: 'knowledge/:id', component: () => import('@/components/user/KnowledgeDetail.vue'), meta: { title: '知识详情' } },
